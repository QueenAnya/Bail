...
export const makeNewsletterSocket = (config: SocketConfig) => {
	...
	return {
		...
		newsletterFollow: (jid: string) => {
			return executeWMexQuery({ newsletter_id: jid }, QueryIds.FOLLOW, xwa2_newsletter_join_v2)
		},

		newsletterUnfollow: (jid: string) => {
			return executeWMexQuery({ newsletter_id: jid }, QueryIds.UNFOLLOW, xwa2_newsletter_leave_v2)
		},
