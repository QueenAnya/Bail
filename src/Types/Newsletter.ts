...
export type NewsletterMetadata = {
	...
	/** name of newsletter */
	name: string
	/** timestamp of last name modification */
	nameTime: number
	/** description of newsletter */
	description: string
	/** timestamp of last description modification */
...
export type NewsletterFetchedUpdate = {
	...
	/** the message (only when fetching messages, not just updates) */
