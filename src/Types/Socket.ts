...
export type SocketConfig = {
	 ...
	 * from `browser`, which breaks pairing by code for any integrator that puts
	 * a product name in `browser[0]` -- even though that same value is accepted
	 * for QR pairing and is precisely what the user then sees under "Linked
	 * devices".
	 *
