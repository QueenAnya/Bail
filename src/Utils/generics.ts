...
/**
 * Check whether a browser tuple represents an Android device.
 * browser[0] is the OS name (e.g. 'Android', 'iOS', 'Mac OS').
 * Ported from @innovatorssoft/baileys.
 */
export const isAndroidBrowser = (browser: [string, string, string]): boolean => browser[0]?.toUpperCase() === 'ANDROID'
