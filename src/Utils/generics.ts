...
const baileysVersion = [2, 3000, 1038669233]
import type {
	BaileysEventEmitter,
	BaileysEventMap,
	ConnectionState,
...
/**
 * Generate the key.uuid field for an outgoing message — a purely local
 * tracking identifier (never sent in the wire stanza), useful for bots that
 * need their own idempotency/dedup key separate from the WA message ID.
