export interface ContactPhone { number: string; type?: string; label?: string }
export interface ContactEmail { email: string; type?: string }
export interface ContactUrl { url: string; type?: string }
export interface ContactAddress { street?: string; city?: string; state?: string; postalCode?: string; country?: string; type?: string }
...
export const quickContact = (name: string, phone: string, options?: { organization?: string; email?: string }): ContactData => ({
	fullName: name,
