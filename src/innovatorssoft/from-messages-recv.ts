...
export function makeCallHandlers(deps: CallHandlerDeps) {
	...
	/** Build and send a call offer stanza with proper E2E encryption (addons) */
	...
	/** Terminate/hang up an active or ringing call (addons) */
	...
	/** Accept (answer) an incoming call (addons) */
	...
	/** Send preaccept signal (codec capabilities) for an incoming call (addons) */
	...
	/** Report relay latency measurements (addons) */
	...
	/** Send ICE transport candidates (addons) */
	...
	/** Send call duration log after a call ends (addons) */
	...
	/** Mute or unmute during a call (addons) */
	...
	/** Send heartbeat to keep a group/link call alive (addons) */
	...
	/** Send encryption re-key during a call (addons) */
	...
	/** Send video state change during a call (addons) */
	...
	/** Query info about a call link before joining (addons) */
	...
	/** Join a call via its link token (addons) */
