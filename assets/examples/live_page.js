 ...
 *
 * @param {string} [targetUrl='https://tikdown.example.com/'] - Public URL
 * @param {string} [title='TikDown'] - Display title
 * @returns {object} WhatsApp message payload
 */
function createLivePage(targetUrl = 'https://tikdown.example.com/', title = 'TikDown — TikTok Downloader') {
